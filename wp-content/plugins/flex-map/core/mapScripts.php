...
class mapScripts {
    ...
    function mymaps_add_admin_scripts() {
        ...
        if (isset($screen->id) && $screen->id == $this -> slug_name . '_page_map-post')
        {
            ...
            wp_enqueue_script('googlemap-script', 'https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=weather,places&sensor=false' . $api_key, null, '1.0.0', TRUE);
            //wp_enqueue_script('googlemap-script', 'https://maps.googleapis.com/maps/api/js?sensor=false', null, '1.0.0', TRUE);
