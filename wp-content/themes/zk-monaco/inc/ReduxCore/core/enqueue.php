    ...
    if ( ! class_exists( 'reduxCoreEnqueue' ) ) {
        class reduxCoreEnqueue {
            ...
            private function set_localized_data() {
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", esc_html__( 'You have changes that are not saved. Would you like to save them now?', "zk-monaco" ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", esc_html__( 'Are you sure? Resetting will lose all custom values.', "zk-monaco" ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", esc_html__( 'Are you sure? Resetting will lose all custom values in this section.', "zk-monaco" ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', "zk-monaco" ) );
                global $pagenow;
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => esc_html__( 'Please Wait', "zk-monaco" ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => esc_html__( 'There was an error saving. Here is the result of your action:', "zk-monaco" ),
                    'alert'   => esc_html__( 'There was a problem with your action. Please try again or reload the page.', "zk-monaco" ),
                );
