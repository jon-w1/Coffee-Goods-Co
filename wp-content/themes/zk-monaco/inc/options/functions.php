        ...
        class Redux_Framework_sample_config {
            ...
            public function setHelpTabs() {
                ...
                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-1',
                    'title'   => esc_html__( 'Theme Information 1', 'zk-monaco' ),
                    'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'zk-monaco' )
                );

                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-2',
                    'title'   => esc_html__( 'Theme Information 2', 'zk-monaco' ),
                    'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'zk-monaco' )
                );

                // Set the help sidebar
                $this->args['help_sidebar'] = esc_html__( '<p>This is the sidebar content, HTML is allowed.</p>', 'zk-monaco' );
            }
