...
class WW_News_Tabs_Widget extends WP_Widget {
    ...
    function WW_News_Tabs_Widget() {
        parent::__construct(
                'ww_news_tabs', __('CS News Tab Widget', 'zk-monaco' ), array('description' => esc_html__('Popular post, recent post and comments.', 'zk-monaco' ),)
        );
    }
            ...
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs clearfix">
                    <?php if ($show_popular_posts == 'true'): ?>
                        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo __('Popular', 'zk-monaco' ); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_recent_posts == 'true'): ?>
                        <li><a href="#tab2" data-toggle="tab"><?php echo __('Recent', 'zk-monaco' ); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_comments == 'true'): ?>
                        <li><a href="#tab3" data-toggle="tab"><?php echo __('Comments', 'zk-monaco' ); ?></a></li>
                    <?php endif; ?>
                </ul>
                                    ...
                                    <?php while ($popular_posts->have_posts()): $popular_posts->the_post(); ?>
                                        <li>
                                            ...
                                            <div class="cs-details table-cell">
                                                ...
                                                <div class="readmore">
                                                    <a href="<?php the_permalink(); ?>"><?php echo __('Read More...', 'zk-monaco' ) ?></a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php endwhile; ?>
