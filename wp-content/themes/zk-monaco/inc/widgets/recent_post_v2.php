...
class CS_Recent_Post_Widget_V2 extends WP_Widget {
    ...
    function CS_Recent_Post_Widget_V2() {
        parent::__construct(
                'cs_recent_post_v2', __('CS Recent Posts', 'zk-monaco' ), array('description' => esc_html__('Recent Posts Widget.', 'zk-monaco' ),)
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts', 'zk-monaco' ) : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo ''.$this->get_field_id('title'); ?>"><?php esc_html_e( 'Title:', 'zk-monaco' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_date'); ?>"><?php esc_html_e( 'Show date:', 'zk-monaco' ); ?></label>
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_decs'); ?>"><?php esc_html_e( 'Show Description:', 'zk-monaco' ); ?></label>
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('number'); ?>"><?php esc_html_e( 'Number of products to show:', 'zk-monaco' ); ?></label>
